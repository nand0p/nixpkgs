...
let
  buildbot-pkg = pythonPackages.buildPythonPackage rec {
    ...
    src = fetchurl {
      url = "https://pypi.python.org/packages/8f/37/6de8734299b94c6d853d2380f0a2cdadf00d24bbac6b8947ea2d3848d15d/${name}.tar.gz";
...
in {
  ...
  www = pythonPackages.buildPythonPackage rec {
    ...
    format = "wheel";
    src = fetchurl {
      url = "https://pypi.python.org/packages/f4/3c/8bf1add762739d1a15d63c91140d7fdc32d872860229ffdb10e735fdaa7a/${name}-py2-none-any.whl";
